...
| [jsonc/no-parsing-error-in-vue-custom-block](https://ota-meshi.github.io/eslint-plugin-jsonc/rules/no-parsing-error-in-vue-custom-block.html) | disallow parsing errors in vue custom blocks |  | :star: | :star: | :star: |
